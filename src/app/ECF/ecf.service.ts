...
export class EcfService {
  ...
  ecfsummarySearch(CreateList: any): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(ecfmodelurl + "ecfserv/ecf_hdrsearch", CreateList, { 'headers': headers })
  }
  ...
  ecfcosummarySearch(CreateList: any): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(ecfmodelurl + "ecfserv/searchempquery", CreateList, { 'headers': headers })
  }
  //Commodity Search
  ...
  // }
  //ECF Approval Search
  approvalsummarySearch(CreateList: any): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(ecfmodelurl + "ecfserv/ecf_approvalsearch", CreateList, { 'headers': headers })
  }
  ...
  //APPROVER DROPDOWN
  public getapprover(approverkeyvalue,id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let urlvalue = ecfmodelurl + 'mstserv/search_employeelimit?commodityid='+id+'&type=ECF&employee=' + approverkeyvalue;
    ...
    //APPROVER SCROLL
  public getapproverscroll(approverkeyvalue, pageno,id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let urlvalue = ecfmodelurl + 'mstserv/search_employeelimit?commodityid='+id+'&type=ECF&employee=' + approverkeyvalue + '&page=' + pageno;
  ...
  public geterapaymode(paymodeid): Observable<any> {
    this.reset();
    const getToken: any = localStorage.getItem('sessionData')
    let tokenValue = JSON.parse(getToken);
    if (paymodeid === undefined) {
  ...
  //   } 
    ...
    public ppxdelete(id: any): Observable<any> {
      ...
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.post<any>(ecfmodelurl + "apserv/ap_ppxdetails?delete=true", id, { 'headers': headers })
    }
