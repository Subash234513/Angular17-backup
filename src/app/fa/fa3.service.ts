...
export class Fa3Service {
  ...
  constructor(private http: HttpClient, private idle: Idle,private httpBackend:HttpBackend ) {
  ...
  public getbusinesssegmentfilter(name,pageno): Observable<any> {
    ...
    return this.http.get<any>(atmaUrl + 'mstserv/businesssegmentsearch?page=' + pageno + '&name=' + name + '&no=' + no, { 'headers': headers })
  }
  ...
  public getcostcentrefilter(bsid,name): Observable<any> {
    ...
    return this.http.get<any>(atmaUrl + 'mstserv/searchbs_cc?bs_id=' + bsid + '&query=' + name, { 'headers': headers })
  }
  ...
  public getlocationfilter(pageno,name): Observable<any> { 
    ...
    const headers = { 'Authorization': 'Token ' + token }
    console.log("name",pageno,"no",name)
    return this.http.get<any>(atmaUrl + 'faserv/assetlocation?page=' + pageno + '&query=' + name, { 'headers': headers })
  }
  ...
  public getEmployeeBranchSearchFilter(branchval,pageno): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'usrserv/search_employeebranch?query=' + branchval + '&page=' + pageno, { 'headers': headers })
  }
  public getAssetSearchFilter(subcatname,pageno): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'faserv/assetcat?subcatname=' + subcatname + '&page=' + pageno, { 'headers': headers })
  }
  public getAssetIdSearchFilter(barcode,pageno): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'faserv/assetdetails?barcode=' + barcode + '&page=' + pageno, { 'headers': headers })
  }
  ...
  public getCustomerFilter(subcatname,pageno): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'mstserv/customer?page=' + pageno + '&name=' + subcatname, { 'headers': headers })
  }
  ...
  public getCustomerStateFilter(page:any,data:any): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'mstserv/state?page='+page+'&data='+data, { 'headers': headers })
  }
