...
export class ApproverComponent implements OnInit {
   ...
   this.date_asset = this.datePipe.transform(date,"yyyy-MM-dd");
     ...
     getassetcategorysummary(d){
      ...
      getApi(){
        ...
        this.Faservice.getapprover(this.pageNumber,search).subscribe((data) => {
  ...
  goBack(){
    this.Faservice.getapprover(this.pageNumber,'').subscribe((data) => {
      console.log( data);
        this.listcomments = data['data'];
        this.datapagination = data['pagination'];
        console.log('d-',data['data']);
  ...
  buknextClick() {
    ...
    if (this.has_nextbuk === true) {
      ...
      this.Faservice.getbackin_pv(this.pageNumber = this.presentpagebuk + 1, 10,'').subscribe(data => {
        console.log(data)
        this.listcomments = data[0]['data'];
        this.datapagination = data[0]['pagination'];
        this.spinner.hide();
