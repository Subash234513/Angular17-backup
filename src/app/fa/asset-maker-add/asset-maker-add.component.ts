...
autocompletecommodityScroll_branch() {
  ...
  splitsubmit(){
    ...
    // listItem['Product_id']=this.Subcatid_product_id;
      ...
      s['Asset_Value']=Math.round(this.sub_asset_data['unit_prices'] * (this.splitquantity.get('listofquantity') as FormArray).at(i).get('asset_quantity').value);
      s['Product_id']=d.id;
  ...
  //  console.log(this.datepipe.transform(dw,'dd-mm-yyyy'))
    ...
    listItem['Asset_Value']=Math.round(listItem.unit_prices * listItem.faclringdetails_qty);//listItem.faclringdetail_totamount/listItem.faclringdetails_qty
