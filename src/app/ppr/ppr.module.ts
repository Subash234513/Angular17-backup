...
@NgModule({
  declarations: [PprSummaryComponent, PprViewComponent, BudgetBuilderComponent, CostAllocationComponent, CostTransactionComponent, VarianceAnalysisComponent, PprLevelComponent, EmployeeBusinessMappingComponent, BudgetBuilderApproveComponent, BudgetBuilderViewerComponent, BudgetBuilderCheckerComponent, PprActiveClientComponent, DssReportComponent, PprSourcesComponent, HeadGroupsComponent, GlSubgroupComponent, SubGroupsComponent],
  imports: [
    NgxPaginationModule,
    PprRoutingModule,
    NgbModule,
