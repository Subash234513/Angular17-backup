...
export class PprService {
  ...
  public get_bs_dropdown(sector_id,query,pagenumber) {
    ...
    // let urlvalue = url + 'usrserv/search_ccbs?query=' + query+"&page="+pagenumber;
    let urlvalue = url + 'pprservice/bs_fetch?query=' + query+"&page="+pagenumber;
    return this.http.get(urlvalue, {
      headers: new HttpHeaders()
        .set('Authorization', 'Token ' + token)
    }
  ...
  public get_cc_dropdown(sector_id,query,pagenumber) {
    ...
    // let urlvalue = url + 'usrserv/search_ccbs?query=' + query+"&page="+pagenumber;
    let urlvalue = url + 'pprservice/cc_fetch?query=' + query+"&page="+pagenumber;
    return this.http.get(urlvalue, {
      headers: new HttpHeaders()
        .set('Authorization', 'Token ' + token)
    }
  ...
  public get_cost_allocation_summary(pagenumber,srachid,bscc,cc,bs) {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    urlvalue = url + 'pprservice/fetch_all?page='+pagenumber+'&core_bscc='+bscc+'&bs_id='+bs+'&cc_id='+cc;
    return this.http.get(urlvalue, {
      headers: new HttpHeaders()
        .set('Authorization', 'Token ' + token)
    }
...
public get_status(query) {
  ...
  incomeupload(file_uplode):Observable<any>{
    ...
    return this.http.post(url + 'pprservice/fileupload_cc_income',formdata,{ 'headers': header})
  }
