...
export class masterService {
  ...
  public addPermission(json: any, empId: number): Observable<any> {
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(url + 'usrserv/permission_admin', this.permissionJson, { 'headers': headers })
  }
...
public getstatedatafilter(id:any,data:any,page:any): Observable<any> {
 ...
 public getsummarycity(id:any,page:any): Observable<any> {
    ...
    public getsectorsummary(data:any,page:any): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      ...
      const headers = { 'Authorization': 'Token ' + token }
      let params: any = new HttpParams();
      return this.http.get<any>(url + 'mstserv/sector_search?page='+page+'&query='+data,{ 'headers': headers })
    }
    ...
    public getPMDServ(pageNumber, pageSize,code,name,location): Observable<any> {
      this.reset();
      const getToken: any = localStorage.getItem('sessionData')
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
     ...
     // console.log(params);
     // console.log(headers);
      return this.http.get<any>(url + "mstserv/pmd_branch?page=" + pageNumber+'&name='+name+'&code='+code+'&location='+location, { 'headers': headers, params })
    }
    ...
    public expencesummarydata(page:any,data:any): Observable<any> {
      this.reset();
      const getToken: any = localStorage.getItem('sessionData')
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      ...
      //console.log("bs Data", data)
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + 'mstserv/expensegrp?page='+page+'&query='+data, { 'headers': headers })
    ...
    public getCommoditySearch(code, name,page:any): Observable<any> {
      this.reset();
      const getToken: any = localStorage.getItem('sessionData')
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      ...
      return this.http.get<any>(url + 'mstserv/commoditysearch?name=' + names + '&code=' + codes, { 'headers': headers })
    }
    ...
    public getAppVersionMaster(pageNumber = 1, pageSize = 10, d,i): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      ...
      params = params.append('page', pageNumber.toString());
      params = params.append('pageSize', pageSize.toString());
      return this.http.get<any>(url + "mstserv/appversion?page=" + pageNumber +"&no="+d+"&remarks="+i, { 'headers': headers })
    }
    ...
    public getClientMaster(pageNumber = 1, pageSize = 10, d, i): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      ...
      params = params.append('page', pageNumber.toString());
      params = params.append('pageSize', pageSize.toString());
      return this.http.get<any>(url + "mstserv/create_client?page=" + pageNumber +"&code="+d+"&name="+i, { 'headers': headers })
    }
    ...
    public getModulesListAdmin(): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "usrserv/usermodule_admin", { 'headers': headers })
    }
    ...
    public getRoleAdmin(): Observable<any> {
      ...
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "usrserv/role_admin", { 'headers': headers })
    }
    public getTitleDropdown(): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "mstserv/title", { 'headers': headers })
    }
    public MasterDegreeSummary(data,page): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "mstserv/degree?query="+data+"&page="+page, { 'headers': headers })
    }
    public MasterDegreeSubmit(data): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.post<any>(url + "mstserv/degree",data, { 'headers': headers })
    }
    public MasterDegreeSummaryEdit(data): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "mstserv/degree/"+data, { 'headers': headers })
    }
    public MasterStreamSummary(data,page): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "mstserv/stream?query="+data+"&page="+page, { 'headers': headers })
    }
    public MasterStreamSummaryEdit(data): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.get<any>(url + "mstserv/stream/"+data, { 'headers': headers })
    }
    public MasterStreamSubmit(data): Observable<any> {
      this.reset();
      const getToken = localStorage.getItem("sessionData");
      let tokenValue = JSON.parse(getToken);
      let token = tokenValue.token
      const headers = { 'Authorization': 'Token ' + token }
      return this.http.post<any>(url + "mstserv/stream",data, { 'headers': headers })
    }
