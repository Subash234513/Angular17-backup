...
import { DegreeMasterComponent } from './degree-master/degree-master.component';
import { StreamMasterComponent } from './stream-master/stream-master.component';
@NgModule({
  declarations: [
    ...
    CreateAppVersionComponent, CreateClientComponent, EditClientComponent, EmpbranchCreateComponent, EmpbranchEditComponent, DegreeMasterComponent, StreamMasterComponent
