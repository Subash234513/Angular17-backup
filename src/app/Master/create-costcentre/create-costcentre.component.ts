...
// }
  ...
  CCSubmit(){
    ...
    if (this.CCForm.value.no.trim().length > 20){
      this.toastr.error('Not more than 20 characters','Enter valid no' );
      return false;
    }
    ...
    if (this.CCForm.value.remarks.trim()===""){
      this.toastr.error('Add Remarks Field',' WhiteSpace Not Allowed');
      return false;
    }
    ...
    if (this.CCForm.value.description.trim()===""){
      this.toastr.error('Add Description Field',' WhiteSpace Not Allowed');
      return false;
    }
