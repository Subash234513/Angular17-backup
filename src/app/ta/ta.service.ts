...
export class TaService {
  ...
  public getTourAdminSummary(statusId, pageNumber, val, bookingtype): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(taURL + "taserv/admin_summary?type=tour&status=" + statusId + "&booking_type=" + bookingtype + "&page=" + pageNumber + val, { 'headers': headers })
  ...
  public gettourreportxl(page, book, tourid, startdate, enddate) {
    this.reset();
    let token = '';
    const getToken = localStorage.getItem("sessionData");
    if (getToken) {
    ...
    if ((tourid != undefined || tourid != null) && (startdate != undefined || startdate != null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + 'taserv/report_tour_requirements_download?tour_no=' + tourid + '&booking_type=' + book + '&start_date=' + startdate + '&end_date=' + enddate + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })

    }
    else if ((tourid == undefined || tourid == null) && (startdate != undefined || startdate != null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + 'taserv/report_tour_requirements_download?booking_type=' + book + '&start_date=' + startdate + '&end_date=' + enddate + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })
    }
    else if ((tourid != undefined || tourid != null) && (startdate == undefined || startdate == null) && (enddate == undefined || enddate == null)) {
      return this.http.get<any>(taURL + 'taserv/report_tour_requirements_download?tour_no=' + tourid + '&booking_type=' + book + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })
    }
    else if ((tourid != undefined || tourid != null) && (startdate != undefined || startdate != null) && (enddate == undefined || enddate == null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements_download?tour_no=" + tourid + '&booking_type=' + book + '&start_date=' + startdate + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })

    }
    else if ((tourid != undefined || tourid != null) && (startdate == undefined || startdate == null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements_download?tour_no=" + tourid + '&booking_type=' + book + '&end_date=' + enddate + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })

    }
    else if ((tourid == undefined || tourid == null) && (startdate == undefined || startdate == null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements_download?booking_type=" + book + "&end_date=" + enddate + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })
    }
    else if ((tourid == undefined || tourid == null) && (startdate != undefined || startdate != null) && (enddate == undefined || enddate == null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements_download?booking_type=" + book + "&start_date=" + startdate + "&page=" + page, { 'headers': headers, responseType: 'blob' as 'json' })

    }
    else {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements_download?booking_type=" + book + '&page=' + page, { 'headers': headers, responseType: 'blob' as 'json' })

    }

    // return this.http.get<any>(taURL + 'taserv/report_tour_requirements_download?booking_type='+book+'&page='+ page, { headers, responseType: 'blob' as 'json' })
  }
  ...
  public getsearchtourdetailreport(tourid, page, book, startdate, enddate): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    if ((tourid != undefined || tourid != null) && (startdate != undefined || startdate != null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + 'taserv/report_tour_requirements?tour_no=' + tourid + '&booking_type=' + book + '&start_date=' + startdate + '&end_date=' + enddate + "&page=" + page, { 'headers': headers })

    }
    else if ((tourid == undefined || tourid == null) && (startdate != undefined || startdate != null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + 'taserv/report_tour_requirements?booking_type=' + book + '&start_date=' + startdate + '&end_date=' + enddate + "&page=" + page, { 'headers': headers })
    }
    else if ((tourid != undefined || tourid != null) && (startdate == undefined || startdate == null) && (enddate == undefined || enddate == null)) {
      return this.http.get<any>(taURL + 'taserv/report_tour_requirements?tour_no=' + tourid + '&booking_type=' + book + "&page=" + page, { 'headers': headers })
    }
    else if ((tourid != undefined || tourid != null) && (startdate != undefined || startdate != null) && (enddate == undefined || enddate == null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements?tour_no=" + tourid + '&booking_type=' + book + '&start_date=' + startdate + "&page=" + page, { 'headers': headers })

    }
    else if ((tourid != undefined || tourid != null) && (startdate == undefined || startdate == null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements?tour_no=" + tourid + '&booking_type=' + book + '&end_date=' + enddate + "&page=" + page, { 'headers': headers })

    }
    else if ((tourid == undefined || tourid == null) && (startdate == undefined || startdate == null) && (enddate != undefined || enddate != null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements?booking_type=" + book + "&end_date=" + enddate + "&page=" + page, { 'headers': headers })
    }
    else if ((tourid == undefined || tourid == null) && (startdate != undefined || startdate != null) && (enddate == undefined || enddate == null)) {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements?booking_type=" + book + "&start_date=" + startdate + "&page=" + page, { 'headers': headers })

    }
    else {
      return this.http.get<any>(taURL + "taserv/report_tour_requirements?booking_type=" + book + '&page=' + page, { 'headers': headers })

    }
    // return this.http.get<any>(taURL + 'taserv/report_tour_requirements?booking_type='+book+'&tour_id='+tourid+'&requested_date='+startdate+'&page='+page, { 'headers': headers })
  }
