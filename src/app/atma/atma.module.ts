...
import { QuestypemasterComponent } from './questypemaster/questypemaster.component';
import { QuesheaderMasterComponent } from './quesheader-master/quesheader-master.component';
import { QuestionmasterComponent } from './questionmaster/questionmaster.component';
import { DocumentQuestionerMappingComponent } from './document-questioner-mapping/document-questioner-mapping.component';
...
import { PortaluserSummaryComponent } from './portaluser-summary/portaluser-summary.component';
import { ActivityQuestionnaireComponent } from './activity-questionnaire/activity-questionnaire.component';
...
@NgModule({
  declarations: [VendorMasterComponent, TaxComponent, TaxEditComponent, SubTaxComponent,
    ...
    HsnComponent, HsnEditComponent, RiskComponent, RiskEditComponent, RiskmodificationComponent, KycComponent, KycEditComponent, KycmodificationComponent, BcpModificationComponent, DuediligenceModificationComponent, QuestypemasterComponent, QuesheaderMasterComponent, QuestionmasterComponent, DocumentQuestionerMappingComponent, 
    EvaluationComponent, ActivitymasterComponent, QuestionmappingComponent, PortaluserComponent, PortaluserSummaryComponent, ActivityQuestionnaireComponent
  ],
