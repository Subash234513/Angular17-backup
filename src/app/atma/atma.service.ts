...
// const vowUrl = 'http://143.110.244.51:8189/'
const vowUrl = 'http://192.168.1.3:8000/'
...
export class AtmaService {
  ...
  public getEmployeeSearchFilter2(empkeyvalue, pageno): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'usrserv/searchrm?query=' + empkeyvalue + '&page=' + pageno, { 'headers': headers })
  }
  // search_hsn
  public hsnsearch(empkeyvalue, pageno): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + 'mstserv/search_hsn?query=' + empkeyvalue, { 'headers': headers })
  }
  // tax search
  ...
  public get_parentScroll_doc(parentkeyvalue, vendorId, pageno): Observable<any> {
    ...
    let urlvalue = atmaUrl + 'venserv/evalute_venodor_doc/' + vendorId + '?query=' + parentkeyvalue + '&page=' + pageno;
    return this.http.get(urlvalue, {
      headers: new HttpHeaders()
        .set('Authorization', 'Token ' + token)
    }
  ...
  public getParentDropDown_doc(parentkeyvalue, vendorId): Observable<any> {
    ...
    let urlvalue = atmaUrl + 'venserv/evalute_venodor_doc/' + vendorId + '?query=' + parentkeyvalue;
    console.log(urlvalue);
    return this.http.get(urlvalue, {
      headers: new HttpHeaders()
        .set('Authorization', 'Token ' + token)
  ...
  public gettaxsummarydata(data: any, search: any) {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get(atmaUrl + 'mstserv/newtaxsummary?' + 'data=' + search + '&page=' + data, { 'headers': headers });
  }
  ...
  public QuestypeEditForms(quesJson, id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let quesEditjson = Object.assign({}, idValue, quesJson)
    return this.http.post<any>(atmaUrl + "mstserv/question_type", quesEditjson, { 'headers': headers })
  }
  ...
  public QuesHeaderEditForms(queshdrJson, id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let queshdrEditjson = Object.assign({}, idValue, queshdrJson)
    return this.http.post<any>(atmaUrl + "mstserv/questionheader", queshdrEditjson, { 'headers': headers })
  }
  ...
  public QuesCreateForms(questionJson): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    console.log("quespost", questionJson)
    return this.http.post<any>(atmaUrl + "mstserv/question", questionJson, { 'headers': headers })
  }
  public QuesEditForms(questionJson): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
  ...
  public questionsingleget(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + "mstserv/question/" + id, { 'headers': headers })
  }
  public getsubquestion(id, pageNumber = 1): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let params: any = new HttpParams();
    params = params.append('page', pageNumber.toString());
    return this.http.get<any>(atmaUrl + "mstserv/question/" + id + "/ques_subquestion_get?page=" + pageNumber, { 'headers': headers })
  }
  ...
  public questypedelete(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.delete<any>(atmaUrl + "mstserv/question_type/" + id, { 'headers': headers })
  }

  public quesheaderdelete(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.delete<any>(atmaUrl + "mstserv/questionheader/" + id, { 'headers': headers })
  }

  public questiondelete(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.delete<any>(atmaUrl + "mstserv/question/" + id, { 'headers': headers })
  }

  public subquestiondelete(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.delete<any>(atmaUrl + "mstserv/questionsuboptions/" + id, { 'headers': headers })
  }

  public venmapdelete(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.delete<any>(atmaUrl + "mstserv/get_vendorclassfication/" + id, { 'headers': headers })
  }
  ...
  public activitydraft(json): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    console.log("docpost", json)
    return this.http.post<any>(atmaUrl + "venserv/activity_answer_create", json, { 'headers': headers })
  }
  ...
  public evaluateactivitysubmit(vendorid): Observable<any> {
    ...
    return this.http.get<any>(atmaUrl + "venserv/evaluate_supplier/"+vendorid, { 'headers': headers })
  }

  public ActivitymstrForm(actJson): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    console.log("actpost", actJson)
    return this.http.post<any>(atmaUrl + "mstserv/activity", actJson, { 'headers': headers })
  }

  public actmastersingleget(id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(atmaUrl + "mstserv/get_activity/" + id, { 'headers': headers })
  }

  public getactivitymaster(summarydata, pageNumber = 1): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let params: any = new HttpParams();
    params = params.append('page', pageNumber.toString());
    return this.http.get<any>(atmaUrl + "mstserv/activity?query=" + summarydata + "&page=" + pageNumber, { 'headers': headers })
  ...
  public deleteactivity(id): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.delete<any>(atmaUrl + "mstserv/get_activity/" + id, { 'headers': headers })
  }

  public ActivityEditForms(actJson, id): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    let Editjson = Object.assign({}, idValue, actJson)
    console.log("Editjson", Editjson)
    return this.http.post<any>(atmaUrl + "mstserv/activity", Editjson, { 'headers': headers })
  }
  ...
  public PortalActiveForm(createJson): Observable<any> {
    ...
    return this.http.post<any>(vowUrl+"usrserv/portal_create", jsondata, { 'headers': headers })
  }

  public getactivitydropdown(value,page): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    // let params: any = new HttpParams();
    // params = params.append('page', pageNumber.toString());
    return this.http.get<any>(atmaUrl + "mstserv/activity?query="+value+"&page="+page, { 'headers': headers })
  }
  ...
  public getportalusersummary(value): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(vowUrl+"usrserv/user_summary?code="+value+"&page=1", { 'headers': headers })
  }
  ...
  public gethistory(type,activity): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    ...
    // params = params.append('page', pageNumber.toString());
    // return this.http.get<any>(atmaUrl + "venserv/ques_trans/"+value+"?type="+type, { 'headers': headers })
    return this.http.get<any>(atmaUrl + "venserv/activity_trans/"+activity+'?type='+type, { 'headers': headers })
  }
  
  public getportaluserupdate(json): Observable<any> {
    this.reset();
    const getToken = localStorage.getItem("sessionData")
    let tokenValue = JSON.parse(getToken);
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(atmaUrl + "venserv/portal_flag_update" , json, { 'headers': headers })
  ...
  public createportal(portalcode,json): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.post<any>(vowUrl + "usrserv/create_portal_user?code="+portalcode , json, { 'headers': headers })
  ...
  public getRolesList(): Observable<any> {
    ...
    let token = tokenValue.token
    const headers = { 'Authorization': 'Token ' + token }
    return this.http.get<any>(vowUrl + "usrserv/role", { 'headers': headers })
  }
