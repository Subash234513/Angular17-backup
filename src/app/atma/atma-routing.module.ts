...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'questype',component: QuestypemasterComponent },
      { path: 'quesheadermaster',component: QuesheaderMasterComponent},
      { path: 'quesmaster',component: QuestionmasterComponent},
      { path: 'docquesmapping',component:DocumentQuestionerMappingComponent},
      { path:'evaluation',component:EvaluationComponent},
      { path:'activitymaster',component:ActivitymasterComponent},
      {path:'vendormapping',component:QuestionmappingComponent},
      {path: 'portalusersummary',component:PortaluserSummaryComponent},
      { path:'activity_questionnaire',component:ActivityQuestionnaireComponent},
